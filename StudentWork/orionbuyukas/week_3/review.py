...
class Person(object):
    def __init__(self, first_name, last_name): #constructor, builds the object, "bake me a cake"
...
p = Person("Kevin", "Long") #bake me a cake store it in p, with parameters "kevin long"
print(p.first_name)
