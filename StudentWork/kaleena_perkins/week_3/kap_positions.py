...
#   a. calculate the distance to each neighbor
    # list to hold distances of all points
    # loop through to find data_point and hold position in variables
    # if data_point in data:
    # 	p1 = [data_point[0], data_point[1]]
    # 	print p1
        # variables to hold 1st and 2nd values of list

        # find linear distance


# print distances  # b. sort the list by that distance
