...
class CentralCorridor(Scene):
	...
	def enter(self):
		...
		if action == "shoot!":
			...
			print "completely ruins the brand new costume his mother bought him, which"
			print "makes him fly into an insane rage and blasts you repeatedly in the face until"
			...
			print "Allway ichaelmay aybay oviesmay equalway itshay."
			print "The Gothon stops, then busts out laughing and can't move."
...
class LaserWeaponArmory(Scene):
	...
	def enter(self):
		...
		print "for more Gothans that might be hiding. It's quiet, too quiet."
...
class TheBridge(Scene):
	...
	def enter(self):
		...
		if action == "throw the bomb":
			...
			print "and blast the lock so the Gothans can't get out."
...
class EscapePod(Scene):
	...
	def enter(self):
		...
		print "but you don't have time to look. There's 2 pods, which one"
		print "do you take?"
