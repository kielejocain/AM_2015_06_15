...
i = 12
# Float: A floating-point/decimal number can hold fractional
# values (e.g. 1.0, 0.25 13.79)
f = 33.33
half = 1.0 / 2.0
...
# List: A list is an ordered collection of values that can be
# referenced by position in the list [0,1,2,3,...]
# 0 is the index of the first item, 1 is the second item 2 is
# the third item etc
